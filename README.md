...
- Root Directory: `backend` (or leave empty for root Dockerfile)
- Dockerfile: `Dockerfile`
- Container Port: `3000` (or `10000` on Render)
- Health Check: `/health`
...
CORS_ORIGINS=https://lab-pilot-capbl.vercel.app
```
...
```env
VITE_API_BASE_URL=https://labpilot-9j6s.onrender.com
```
...
- Add your deployed frontend URL (`https://lab-pilot-capbl.vercel.app`) to `CORS_ORIGINS`.
- Ensure `VITE_API_BASE_URL` points to your deployed backend (`https://labpilot-9j6s.onrender.com`).
...
**Backend API:** https://labpilot-9j6s.onrender.com/docs
