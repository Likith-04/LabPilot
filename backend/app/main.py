...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        - **Lab Manual Upload**: Upload and process laboratory manuals
        - **Smart Retrieval**: Find relevant lab manual content using vector similarity
        - **AI Answers**: Get grounded answers about experiments, procedures, theory, and viva preparation
        - **Multi-Model**: Support for multiple AI providers
        
        ## Quick Start
        
        1. Upload a laboratory manual using `/upload`
