...
const PIPELINE_STEPS = [
  ...
  { id: 6, label: "Session metadata", detail: "Wire lab manual id and counters" },
  {
    id: 7,
...
export function PDFUpload({
  ...
  const handleFile = async (file: File) => {
    ...
    // Validate file type
    if (!isValidPDF(file)) {
      setValidationError("Please upload a laboratory manual in PDF format");
      return;
    }
  ...
  return (
    <div className="w-full">
      ...
      <input
        ...
        className="hidden"
        aria-label="Upload laboratory manual"
      />
                        ...
                        <div className="flex w-full min-w-0 items-start gap-3 sm:w-auto sm:items-center">
                          ...
                          <div className="min-w-0 flex-1 sm:flex sm:items-center sm:gap-3">
                            ...
                            >
                              ...
                              <span className="sm:hidden">Select Lab Manual</span>
                        ...
                        >
                          ...
                          >
                            ...
                            <p className="mt-4 text-xs text-white/80">
                              Supports laboratory manuals in PDF format up to{" "}
                              {formatFileSize(MAX_FILE_SIZE)}
                            </p>
                          </div>
                        </motion.div>
