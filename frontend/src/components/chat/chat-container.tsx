...
const DEFAULT_CHAT_MODEL_ID = "llama-3.3-70b-versatile";
  ...
  return (
    <div className="flex w-full min-w-0 min-h-0 flex-col overflow-x-visible">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/90">
                Ask questions about your lab manual
              </p>
            </div>
          </div>
            ...
            <Tooltip>
              ...
              <TooltipContent side="bottom" align="start">
                ...
                <p className="mt-1 text-[11px] text-white/80 leading-snug">
                  This app runs a multi-step RAG flow on the server: lab manual text is
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  ...
                  aria-label={`Open saved workspaces, ${sessions.length} saved`}
                >
            ...
            <Tooltip>
              ...
              <TooltipContent side="bottom" align="center">
                ...
                <p className="mt-1 text-[11px] text-white/80 leading-snug">
                  ...
                  from your lab manual to each reply (when the model returns them).
            ...
            <GlassCard variant="default" padding="sm">
              <div className="mb-3 flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                <div className="min-w-0 flex-1 space-y-1">
                  ...
                  <p className="text-xs leading-relaxed text-slate-300">
                    ...
                    lab manual index (anonymous session); that index can be removed
                    after about {SESSION_INDEX_RETENTION_DAYS} days without use
                    (and on server cleanup)—re-upload the lab manual if retrieval feels
                    off.
                  </p>
                </div>
              ...
              {sessions.length === 0 ? (
                <p className="text-xs text-slate-300">
                  No saved workspaces yet. Upload a lab manual and your history will
                  be saved here.
                </p>
              ) : (
            ...
            <div className="flex items-center justify-between px-2 sm:px-6 py-2 border-b border-white/10">
              <div className="min-w-0">
                <p className="text-xs text-slate-200 truncate">
                  {activeSessionName ?? fileName ?? "Current Lab Manual"}
                </p>
            ...
            {chatHistory.length === 0 && !streamingAnswer ? (
              <div className="flex flex-col items-center justify-center text-center">
                  ...
                  <h3 className="text-base sm:text-lg font-semibold text-white/95 mb-2 tracking-tight">
                    {isLoaded ? "Welcome to LabPilot." : "No Lab Manual uploaded yet"}
                  </h3>
                  <p className="text-xs sm:text-sm text-white/90/95 max-w-7xl leading-relaxed">
                    {isLoaded
                      ? "Ask anything about your lab manual. LabPilot retrieves the relevant context, then your chosen model answers—with automatic fallback if a provider is unavailable."
                      : "Upload your laboratory manual and ask questions about experiments, theory, procedures, algorithms, viva preparation and exam revision."}
                  </p>
                  {isLoaded && (
                    <div className="mt-5 flex flex-wrap justify-center gap-2 max-w-7xl">
                      {[
                        "Explain Experiment 3",
                        "Summarize Experiment 5",
      ...
      <ConfirmAlertDialog
        ...
        title="Clear all saved workspaces?"
        description={
          <>
            This permanently deletes{" "}
            <strong className="text-white">{sessions.length}</strong> saved
            workspace{sessions.length === 1 ? "" : "s"} from IndexedDB in this
      ...
      <ConfirmAlertDialog
        ...
        title="Delete this saved workspace?"
        description={
          sessionToDelete ? (
            <>
              ...
              changes if this lab manual is the one you have open.
            </>
          ) : (
            ""
          )
