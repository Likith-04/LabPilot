          ...
          >
            <GlassCardContent className="text-center">
              <h2 className="sr-only">
                Start Learning with LabPilot Today
              </h2>
              ...
              >
                ...
                >
                  Upload your laboratory manual and get grounded support for
                  experiments, procedures, theory, and viva preparation. No signup required.
                </motion.p>
