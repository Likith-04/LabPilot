      ...
      >
        ...
        >
          ...
          >
            ...
            >
              AI-Powered Lab-Manual Intelligence
            </Badge>
          </motion.div>
          ...
          >
            ...
            >
              Upload your engineering laboratory manual and get clear answers
              about experiments, theory, procedures, algorithms, and viva preparation.
            </motion.span>
            <motion.span
              variants={heroStairItem}
              className="block hero-stair-copy-line"
          ...
          >
            {[
              { icon: FlaskConical, text: "Lab Manual Guidance" },
