...
export const SOCIAL_LINKS = {
  github: "https://github.com/Likith-04/LabPilot.git",
  repository: "https://github.com/Likith-04/LabPilot.git",
  linkedin: "",
  twitter: "",
} as const;
...
export const FEATURES = [
  {
    title: "Lab Manual Analysis",
    description:
      "Upload your engineering laboratory manual and get grounded help with experiments, procedures, and theory.",
  },
  {
    title: "Smart Retrieval",
    description:
      "Using FAISS vector search and embeddings, LabPilot finds the most relevant sections of your lab manual.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Toggle source display to see exactly which lab manual pages contributed to each answer.",
  },
  {
    title: "FAISS Persistence",
    description:
      "Vector index saved to disk automatically — restart the server without re-uploading your lab manual.",
  },
  {
...
export const HOW_IT_WORKS_STEPS = [
  {
    step: 1,
    title: "Upload Your Laboratory Manual",
    description:
      "Simply drag and drop or select your laboratory manual. LabPilot processes it in seconds.",
  },
  {
    step: 2,
    title: "AI Processes Content",
    description:
      "Your lab manual is split into chunks, converted to embeddings, and stored in a vector database.",
  },
  {
    step: 3,
    title: "Ask Questions",
    description:
      "Ask about experiments, theory, procedures, algorithms, and viva preparation.",
  },
] as const;
